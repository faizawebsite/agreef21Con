...
mysqli_query($con,"insert into orders(userId,productId,quantity,amount) values('".$_SESSION['id']."','$qty','$val34','$tprice')");
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Rent Per unit/Year</th>
