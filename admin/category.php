...
?>									
										<tr>
											...
											<td>
		<a href="edit-category.php?id=<?php echo $row['id']?>" class="btn btn-success" ><i class="icon-edit"></i></a><br>
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class=" btn btn-danger"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
