...
if(isset($_GET['action']) && $_GET['action']=="rent"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			$row_p=mysqli_fetch_array($query_p);
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
			header('location:my-cart-rent.php');
		}else{
			$message="Product ID is invalid";
		}
	}
...
if(isset($_POST['submitmsg']))
{
	...
	mysqli_query($con,"insert into messages(name,UserID,Message) values('$name','$uid','$message')");
}
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<br><br>
									<div class="col-sm-7">
										<a href="product-details.php?page=product&action=rent&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Apply for Rent</a>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#sendmsg">Send Message</a></li>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
								...
								<div id="sendmsg" class="tab-pane">
									<div class="product-tab">
																				
										<div class="product-reviews">
											<h4 class="title">Farmer Message to Consultant</h4>
										...
										<div class="product-add-review">
											<h4 class="title">Write your Message</h4>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Your ID/User Name<span class="astk">*</span></label>
																	<input type="text" class="form-control txt" id="exampleInputSummary" placeholder="" name="uid" required="required">
																</div><!-- /.form-group -->
															</div>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="message" required="required"></textarea>
																</div><!-- /.form-group -->
															</div>
														</div><!-- /.row -->
														
														<div class="action text-right">
															<button name="submitmsg" class="btn btn-primary btn-upper">SUBMIT Message</button>
														</div><!-- /.action -->
